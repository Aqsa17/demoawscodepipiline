...
<body>
  ...
  <!-- section 1 -->
    <div class="container-fluid consultingpage-header py-6 my-6 mt-0" >
     ...
     <div class="container-fluid  py-6 my-6 mt-0" >
        <div class="container ">
            ...
            <div class="row g-5">
                <div class="col-lg-6 col-md-6 consultingbox">
                    <h3>Professional Consulting Services</h3>
                    <p>Probytes Connect’s status as a leading provider of specialist conferences and learning, means that we are uniquely positioned to help with your consultancy requirements & provide you with professional consulting services. Our exclusive partnerships with subject matter experts will help you tackle challenging business and performance issues that require timely execution or advanced levels of experience.
                    Informa’s business consulting services have helped steer executives and employees through a multitude of challenges facing today’s businesses. Our expertise and competencies include:</p>
                    <ul class="consultinglist">
                        <li>Digital Transformation</li>
                        <li>HR Transformation</li>
                        <li>Assessment, design, and implementation of new policies and procedures</li>
                        <li>Lean Business Process Management</li>
                        <li>Process Improvement</li>
                        <li>Leadership</li>
                        <li>Change Initiatives</li>
                        <li>IT/Technology Consulting</li>
                    </ul>
                 </div> 

                <div class="col-lg-6 col-md-6">
                <div class="consultimgbox"><img src="img/consultimg.webp" alt=""></div>
                </div> 
            </div>
        </div>
    </div>
       ...
       <!-- section 1 -->
       <div class="container-fluid  py-6 my-6 mt-0 consultingcardbox" >
        <div class="container ">
            <!-- <h1 class="text-white animated slideInDown">Courses</h1> -->
            <div class="row g-5">
                <div class="col-lg-3 col-md-6 ">
                    <div class="card consultingcard">
                        <div class="card-body">
                            
                            <p class="card-text">Large-scale consulting firms in Dubai are generally only interested in ‘big’ projects – typically 100s of man-days with exorbitant fees</p>
                        <ul type="circle">
                            <li class="circletypelistitem">Probytes can offer smaller-scale and flexibility</li>
                        </ul>
                        </div>
                    </div>
                 </div> 
                 ...
                 <div class="col-lg-3 col-md-6 ">
                    <div class="card consultingcard">
                        <div class="card-body">
                            ...
                            <p class="card-text">Many consulting firms ‘blood’ their talent in growth markets to gain experience</p>
                        <ul type="circle">
                            <li class="circletypelistitem">Probytes consultants are leaders in their field and work independently of political influences. You’ll get to work with the best!</li>
                        </ul>
                        </div>
                    </div>
                 </div> 
                 ...
                 <div class="col-lg-3 col-md-6">
                    <div class="card consultingcard">
                        <div class="card-body">
                            ...
                            <p class="card-text">Many of the larger consulting firms in the UAE often require formal commitments for the full period of the engagemen.</p>
                        <ul type="circle">
                            <li class="circletypelistitem">Probytes offers you flexibility, adjusting the man-days up or down dependent on the rate of progress, client understanding and internal capabilities.</li>
                        </ul>
                        </div>
                    </div>
                 </div> 
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card consultingcard">
                        <div class="card-body">
                            ...
                            <p class="card-text">Our promise is a highly proactive approach to consultancy projects, building relationships, credibility and an ability to provide respected and genuinely helpful counsel, up to (and including) CEO level.</p>
                        <!-- <ul type="circle">
                            <li class="circletypelistitem">Probytes can offer smaller-scale and flexibility</li>
                        </ul> -->
                        </div>
            ...
            <div class="row g-5">
            <div class="col-lg-12 col-md-6">
            <a href="#" class="btn btn-primary btn-gtch" >Get In Touch</a>
            </div>
            </div>
